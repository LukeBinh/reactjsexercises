        ...
        <div className='container'>
            <header className="header">
                ...
                <div className="header-menu">
                    <a href="#" className="header-menu_item">Categories</a>
                    <span className="separate">|</span>
                    <a href="#" className="header-menu_item">Contact us</a>
                    <span className="separate">|</span>
                    <a href="#" className="header-menu_item">Follow us</a>
                    <span className="separate">|</span>
                    <a href="./Ex2/index.html" className="header-menu_item">Layout 2</a>
                </div>
                <div className="header-menu_mobile">
                    <i className="fa-solid fa-bars menu_mobile-btn"></i>
                </div>
                <div className="header-search">
                    <input type="text" name="search" placeholder="Search" id="search" className="header-search_input"/>
                </div>
            </header>
                ...
                <div className="product">
                    ...
                    <div className="product-display">
                        <div className="product-box">
                            ...
                            <p className="product-price">Price: <span>10$</span></p>
            ...
            <footer className="footer">
                ...
                <div className="footer-link">
                    <a href="#">Link 1</a>
                    <span className="separate">|</span>
                    <a href="#" className="link-active">Link 2</a>
                    <span className="separate">|</span>
                    <a href="#">Link 3</a>
                </div>
            </footer>
